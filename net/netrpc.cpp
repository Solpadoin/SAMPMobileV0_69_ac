...
void ConnectionRejected(RPCParameters *rpcParams)
{
	...
	{
		pChatWindow->AddInfoMessage("CONNECTION REJECTED: Invalid Nickname!");
		...
		//pChatWindow->AddInfoMessage("Use /quit to exit or press ESC and select Quit Game"); // ESC button doesn't exist on Mobile Devices.
		
		pChatWindow->AddInfoMessage("Use /quit to exit or restart your Mobile App.");
	}
